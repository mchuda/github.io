...
csv <- "/Users/sahanaraju/Downloads/graduate-admissions/Admission_Predict.csv"
df <- read_csv(csv)
df
...
There are certain datasets that do have missing values, and they need to be taken care of. Some options include eliminating entries with missing values and imputing values into missing places. Check out http://uc-r.github.io/missing_values for details on how to do so. 
